...
JS_GLOBALS = {
  ...
  :css_path => ENV['TM_BUNDLE_SUPPORT'] && ENV['TM_BUNDLE_SUPPORT'].gsub(' ', '%20') + '/css/gotofile.css',
...
<html>
	...
	<link rel="stylesheet" type="text/css" href="file://#{JS_GLOBALS[:css_path]}">
	<script>
var myCommand = null;
var actpath = "";
var oldterm;
var fpath = "#{JS_GLOBALS[:fpath]}" + "/";
var dpath = "#{JS_GLOBALS[:dpath]}" + "/";
...
function startSearchTimed() {
    ...
    setSelection(null);
    var cmd = "'#{JS_GLOBALS[:ruby]}' '#{JS_GLOBALS[:bundle_support]}/lib/FileFinder.rb' '" + term + "'";
...
<div id='head'>
<input accesskey="f" tabindex='0' id='search' type='search' incremental autosave='TMFFFSearch' results='20' size='25' placeholder='look for files' onsearch='startSearch(this.value);'>
</div>
<div id='result'>
